        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10">
          <div className="md:col-span-2">
            ...
            <p className="text-lg mt-4">
              Hear directly from our clients about how AssetPlus has helped them
            ...
            >
              <CarouselContent className="-ml-1">
                {testimonials?.map((item, index) => (
                  ...
                  >
                    <div className="p-1">
                      <Card className="h-64 flex flex-col justify-between bg-[var(--rv-third)] border-0 overflow-hidden">
                        <div className="flex items-center justify-center px-6 py-4 flex-grow relative">
                          <div className="text-gray-600 max-h-[4.5rem] overflow-hidden relative line-clamp-3">
                            <div
                        ...
                        <div className="flex px-6 py-2 items-center">
                          ...
                          <div className="ml-4">
                            <h4 className="font-semibold text-[var(--rv-secondary)]">
                              {item?.author}
                            </h4>
