    ...
    return (
        <div className="h-screen">
            <div className="max-w-3xl mx-auto my-40 p-6 bg-gray-50 ring-1 ring-yellow-400 shadow-lg rounded-lg">
                {isModalOpen && (
                    <div className="fixed top-20 inset-0 flex items-center justify-center bg-black bg-opacity-90">
                ...
                {isQuizCompleted ? (
                    <div className="flex flex-col items-center text-center">
                        ...
                        <div className="bg-gray-900 p-4 rounded-lg shadow-inner">
                            ...
                            <ul className="mt-2 text-left">
                                <li className="mb-3"><span className="text-bold text-lg text-gray-900">Critical: </span> Your financial situation is at a very critical level and you need to get some professional help before its too late. We will soon send you a thorough analysis of your financial health.</li>
                                <li className="mb-3"><span className="text-bold text-lg text-gray-900">Weak: </span>Your financial situation is weak. There are certain basic areas that you have taken care of but a majority of them needs to  be worked upon. We will soon send you a thorough analysis of your financial health.</li>
                                <li className="mb-3"><span className="text-bold text-lg text-gray-900">Border Line: </span>We We can see that you have put in effort to plan your finances. But at the same time there certain areas that have been completely ignored. A correct direction along with proper risk profiling and asset allocation is what you might need.</li>
                                <li className="mb-3"><span className="text-bold text-lg text-gray-900">Fit: </span>Good care has been taken in planning your financial life. A good asset allocation and portfolio rebalancing may be required. It will show help in maximising returns by minimizing the risk. We will soon send you a thorough analysis of your financial health.</li>
                                <li className="mb-3"><span className="text-bold text-lg text-gray-900">Excellent:</span> We appreciate the effort you have put into financial planning. You are in the correct direction. Make sure you rebalance your portfolio regularly. We will soon send you a thorough analysis of your financial health.</li>
                            </ul>
                        </div>
                        <button
                            onClick={() => {
                            ...
                            className="mt-6 bg-black text-white px-4 py-2 rounded-lg hover:bg-gray-600"
                        >
                            Back Home
                        </button>
                    </div>
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="mb-4 ">
                            <div className="flex items-center mb-2">
                                <input
                                    ...
                                    className="mr-2"
                                />
                                <label htmlFor={'answer'} className="text-lg">Yes</label>
                            </div>
                            <div className="flex items-center mb-2">
                                <input
                                    type="radio"
                        ...
                        <Button
                            ...
                            className="text-white px-4 py-2 rounded-lg hover:bg-gray-600"
                        >
                            Next
                        </Button>
                    </div>
